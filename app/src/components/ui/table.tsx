...
function TableCell({ className, ...props }: React.ComponentProps<'td'>) {
  return (
    <td
      ...
      className={cn(
        'whitespace-nowrap p-2 align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] [&:nth-child(2)]:min-w-10 [&:not(:nth-child(-n+2)):not(:last-child)]:min-w-50',
        className
      )}
      {...props}
    />
