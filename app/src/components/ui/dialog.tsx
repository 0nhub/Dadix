      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="data-[state=open]:bg-accent data-[state=open]:text-muted-foreground focus:outline-none absolute right-4 top-4 rounded-md p-1 opacity-70 transition-opacity hover:bg-neutral-200 hover:opacity-100 disabled:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0"
          >
